...
public class QuickContactFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Button menu_friend = (Button) root.findViewById(R.id.button1);
        menu_friend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                 Intent intent = new Intent(getActivity(), Menu_friend.class);
                  startActivity(intent);
            }
        });

        Button menu_pathbookmark = (Button) root.findViewById(R.id.button2);
        menu_pathbookmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button menu_setting = (Button) root.findViewById(R.id.button3);
